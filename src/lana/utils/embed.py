...
from discord import Member, TextChannel, Webhook
...
async def add_member_difference_fields(embed: discord_embed, before: Member, after: Member):
    if before.avatar != after.avatar:
        ...
        embed.add_field(
            name="Unrecognized change in member update event",
            value="Please notify the developers of this, preferribly with a explanation of what changed, or a screenshot of audit logs.",
        )
